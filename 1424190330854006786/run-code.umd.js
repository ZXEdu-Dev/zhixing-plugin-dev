...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.RunCode = factory());
})(this, function() {
  "use strict";
  ...
  */
  ...
  var Button$1 = /* @__PURE__ */ forwardRefWithAs(function Button2(props, ref) {
  ...
  const Visible = "_Visible_18c5z_6";
  const Invisible = "_Invisible_18c5z_11";
  const Button = "_Button_18c5z_16";
  const Menu = "_Menu_18c5z_57";
  const Copy = "_Copy_18c5z_65";
  const Icon = "_Icon_18c5z_75";
  const Language = "_Language_18c5z_80";
  const More = "_More_18c5z_88";
  const Editor = "_Editor_18c5z_94";
  const Text = "_Text_18c5z_129";
  const Option = "_Option_18c5z_145";
  const Output = "_Output_18c5z_176";
  var styles = {
    Visible,
    Invisible,
    Button,
    "Run-Code": "_Run-Code_18c5z_44",
    Menu,
    Copy,
    "Copy-Text": "_Copy-Text_18c5z_70",
    Icon,
    Language,
    More,
    Editor,
    "Help-Text": "_Help-Text_18c5z_101",
    "List-Box": "_List-Box_18c5z_107",
    "Button-Box": "_Button-Box_18c5z_111",
    Text,
    "Option-List": "_Option-List_18c5z_145",
    Option,
    "Output-Header": "_Output-Header_18c5z_176",
    Output
  };
  const Widget$1 = ({ languageList, language, onChange }) => {
  ...
  const Widget = ({ options }) => {
    ...
    const runCode = React.useCallback(async () => {
      ...
      try {
        let data = {
          language,
          code: codeMap[language] ? codeMap[language] : ""
        };
        const res = await post("/api/compiler/run", data);
        setOutput(res.data.output);
        setRuntime(res.data.runtime);
        onExecuted(res.data.output.trim());
      } catch (err) {
        onError(err.msg);
      } finally {
        setRunning(false);
    ...
    return /* @__PURE__ */ React.createElement("div", {
    ...
    }, /* @__PURE__ */ React.createElement("header", null, /* @__PURE__ */ React.createElement(Widget$1, {
      ...
      className: `${styles["Copy-Text"]} ${copied ? styles.Visible : styles.Invisible}`
    }, "\u5DF2\u590D\u5236"), /* @__PURE__ */ React.createElement(lib.CopyToClipboard, {
      text: codeMap[language] ? codeMap[language] : "",
      onCopy: () => {
        setCopied(true);
        setTimeout(() => {
          setCopied(false);
      ...
      value: codeMap[language] ? codeMap[language] : "",
      options: {
        fontSize: 14,
      ...
      onChange: (code) => {
        if (!!code.trim()) {
          ...
          delete codeMap[language];
        }
        if (onChange) {
          onChange(JSON.stringify(codeMap));
        }
      }
    })), renderHelpText(), /* @__PURE__ */ React.createElement("footer", null, /* @__PURE__ */ React.createElement("button", {
      disabled: running,
      onClick: () => runCode(),
      className: styles.Button
    }, running ? "\u6B63\u5728\u8FD0\u884C" : "\u8FD0\u884C\u4EE3\u7801")), output ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
      className: styles["Output-Header"]
    }, /* @__PURE__ */ React.createElement("div", null, "\u8F93\u51FA\u7ED3\u679C"), runtime ? /* @__PURE__ */ React.createElement("div", null, runtime, " ms") : null), /* @__PURE__ */ React.createElement("pre", {

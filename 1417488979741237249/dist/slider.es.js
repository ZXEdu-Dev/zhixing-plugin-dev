...
const Content = "_Content_jysfd_6";
const Swiper = "_Swiper_jysfd_1";
const Slide = "_Slide_jysfd_19";
const Radius = "_Radius_jysfd_30";
const Name = "_Name_jysfd_41";
const Controls = "_Controls_jysfd_55";
const Indicator = "_Indicator_jysfd_62";
const Icon = "_Icon_jysfd_70";
var styles = {
  "Swiper-Box": "_Swiper-Box_jysfd_1",
  Content,
  Swiper,
  Slide,
  Radius,
...
const Widget$1 = ({ start: start2, pause: pause2, next: next2, previous, running, step, total }) => {

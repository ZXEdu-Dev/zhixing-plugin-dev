...
const Button2 = "_Button_csaoj_6";
const Menu = "_Menu_csaoj_58";
const Copy = "_Copy_csaoj_66";
const Visible = "_Visible_csaoj_73";
const Invisible = "_Invisible_csaoj_83";
const State = "_State_csaoj_88";
const OK = "_OK_csaoj_92";
const Icon = "_Icon_csaoj_96";
const Editor = "_Editor_csaoj_101";
const Text = "_Text_csaoj_135";
const Option = "_Option_csaoj_152";
const Output = "_Output_csaoj_184";
const Form = "_Form_csaoj_202";
var styles = {
  "Run-Code": "_Run-Code_csaoj_1",
  Button: Button2,
  Menu,
  Copy,
  Visible,
  ...
  Icon,
  Editor,
  "Help-Text": "_Help-Text_csaoj_108",
  "List-Box": "_List-Box_csaoj_113",
  "Button-Box": "_Button-Box_csaoj_117",
  Text,
  "Option-List": "_Option-List_csaoj_152",
  Option,
  "Output-Header": "_Output-Header_csaoj_184",
  Output,
  Form,
  "More-Options": "_More-Options_csaoj_218",
  "Build-Output": "_Build-Output_csaoj_233",
  "lds-grid": "_lds-grid_csaoj_238"
};
...
const Widget = ({ options }) => {
  ...
  const [buildOutput, setBuildOutput] = React.useState("123");
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: `${styles.Output} ${styles["Build-Output"]}`
  }, buildOutput, /* @__PURE__ */ React.createElement("div", {
    className: styles["lds-grid"]
  }, /* @__PURE__ */ React.createElement("div", null), /* @__PURE__ */ React.createElement("div", null), /* @__PURE__ */ React.createElement("div", null), /* @__PURE__ */ React.createElement("div", null)))) : null, output ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {

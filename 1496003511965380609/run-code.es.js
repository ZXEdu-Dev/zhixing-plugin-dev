...
const Button2 = "_Button_2nrmx_6";
const Menu = "_Menu_2nrmx_58";
const Copy = "_Copy_2nrmx_66";
const Visible = "_Visible_2nrmx_73";
const Invisible = "_Invisible_2nrmx_83";
const State = "_State_2nrmx_88";
const OK = "_OK_2nrmx_92";
const Icon = "_Icon_2nrmx_96";
const Editor = "_Editor_2nrmx_101";
const Text = "_Text_2nrmx_135";
const Option = "_Option_2nrmx_152";
const Output = "_Output_2nrmx_184";
const Form = "_Form_2nrmx_202";
var styles = {
  "Run-Code": "_Run-Code_2nrmx_1",
  Button: Button2,
  Menu,
  Copy,
  Visible,
  ...
  Icon,
  Editor,
  "Help-Text": "_Help-Text_2nrmx_108",
  "List-Box": "_List-Box_2nrmx_113",
  "Button-Box": "_Button-Box_2nrmx_117",
  Text,
  "Option-List": "_Option-List_2nrmx_152",
  Option,
  "Output-Header": "_Output-Header_2nrmx_184",
  Output,
  Form
};
...
const Widget = ({ options }) => {
  ...
  const handleRunStage = React.useCallback((data, ws) => {
    setBuildOutput(null);
    if (data.output) {
      setOutput((prev) => {
  ...
  })), mode === "edit" ? renderConfig() : null, renderHelpText(), /* @__PURE__ */ React.createElement("footer", null, /* @__PURE__ */ React.createElement("button", {
    disabled: running,
    onClick: () => runCode(),
  ...
  }, output)) : null, buildOutput ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("pre", {
    className: styles.Output
  }, buildOutput)) : null);
};

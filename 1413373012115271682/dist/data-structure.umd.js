...
(function(global, factory) {
  ...
  const Controls = "_Controls_13ikg_13";
  const Indicator = "_Indicator_13ikg_20";
  const Icon = "_Icon_13ikg_28";
  const Name = "_Name_13ikg_47";
  const Remark = "_Remark_13ikg_69";
  const LinkedList = "_LinkedList_13ikg_86";
  const BinaryHeap = "_BinaryHeap_13ikg_92";
  const Sample = "_Sample_13ikg_92";
  const BinaryTree = "_BinaryTree_13ikg_93";
  const List = "_List_13ikg_110";
  const Item = "_Item_13ikg_119";
  const Arrow = "_Arrow_13ikg_141";
  const Value = "_Value_13ikg_146";
  const Explain = "_Explain_13ikg_154";
  const Stack = "_Stack_13ikg_155";
  const Queue = "_Queue_13ikg_156";
  const Content = "_Content_13ikg_162";
  const Question = "_Question_13ikg_169";
  const Label = "_Label_13ikg_185";
  const Tree = "_Tree_13ikg_265";
  var styles = {
    "Data-Structure": "_Data-Structure_13ikg_13",
    Controls,
    Indicator,
    Icon,
    Name,
    "Play-Box": "_Play-Box_13ikg_61",
    Remark,
    "Array": "_Array_13ikg_85",
    LinkedList,
    BinaryHeap,
    Sample,
    BinaryTree,

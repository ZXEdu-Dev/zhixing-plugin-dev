...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.DataStructure = factory());
})(this, function() {
  "use strict";
  const DATA_STRUCTURE_ARRAY = "Array";
  const DATA_STRUCTURE_LINKED_LIST = "Linked List";
  const DATA_STRUCTURE_STACK = "Stack";
  const DATA_STRUCTURE_QUEUE = "Queue";
  const DATA_STRUCTURE_BINARY_TREE = "Binary Tree";
  const DATA_STRUCTURE_BINARY_HEAP = "Binary Heap";
  const NAME = {
    [DATA_STRUCTURE_ARRAY]: "\u6570\u7EC4",
    [DATA_STRUCTURE_LINKED_LIST]: "\u94FE\u8868",
    [DATA_STRUCTURE_STACK]: "\u94FE\u8868",
    [DATA_STRUCTURE_QUEUE]: "\u961F\u5217",
    [DATA_STRUCTURE_BINARY_TREE]: "\u4E8C\u53C9\u6811",
    [DATA_STRUCTURE_BINARY_HEAP]: "\u4E8C\u53C9\u5806"
  };
  const Controls = "_Controls_5vtny_13";
  const Indicator = "_Indicator_5vtny_20";
  const Icon = "_Icon_5vtny_28";
  const Name = "_Name_5vtny_47";
  const Remark = "_Remark_5vtny_69";
  const LinkedList = "_LinkedList_5vtny_86";
  const BinaryHeap = "_BinaryHeap_5vtny_92";
  const Sample = "_Sample_5vtny_92";
  const BinaryTree = "_BinaryTree_5vtny_93";
  const List = "_List_5vtny_110";
  const Item = "_Item_5vtny_119";
  const Arrow = "_Arrow_5vtny_141";
  const Value = "_Value_5vtny_146";
  const Explain = "_Explain_5vtny_154";
  const Stack = "_Stack_5vtny_155";
  const Queue = "_Queue_5vtny_156";
  const Content = "_Content_5vtny_162";
  const Question = "_Question_5vtny_169";
  const Label = "_Label_5vtny_185";
  const Tree = "_Tree_5vtny_265";
  var styles = {
    "Data-Structure": "_Data-Structure_5vtny_13",
    Controls,
    Indicator,
    Icon,
    Name,
    "Play-Box": "_Play-Box_5vtny_61",
    Remark,
    "Array": "_Array_5vtny_85",
    LinkedList,
    BinaryHeap,
    Sample,
    BinaryTree,
  ...
  spring$6.needsInterpolation = function(a2, b2) {
  ...
  var types = { keyframes: keyframes$1, spring: spring$6, decay };
  ...
  const Widget$7 = ({ data }) => {
    ...
    const renderItem = (item, index) => {
      return /* @__PURE__ */ React.createElement(motion.li, {
        ...
        key: item.layoutId
      }, /* @__PURE__ */ React.createElement("div", null, index), /* @__PURE__ */ React.createElement("div", {
        className: styles.Value
      }, item.value), /* @__PURE__ */ React.createElement("div", null, "0x", prettyHex(index.toString(16), 2)));
    };
    const renderContent = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      whileHover: { scale: 1.1 },
      className: styles.Item
    }, /* @__PURE__ */ React.createElement("div", null, "0"), /* @__PURE__ */ React.createElement("div", {
      className: styles.Value
    }, "123"), /* @__PURE__ */ React.createElement("div", null, "0x12")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", {
      className: styles.Remark
    }, "\u7D22\u5F15"), /* @__PURE__ */ React.createElement("p", {
      className: styles.Remark
    }, "\u5B58\u50A8\u7684\u503C"), /* @__PURE__ */ React.createElement("p", {
      className: styles.Remark
    }, "\u5185\u5B58\u5730\u5740"))), /* @__PURE__ */ React.createElement(AnimateSharedLayout, null, renderContent()));
  };
  const spring$4 = {
    type: "spring",
    stiffness: 500,
  ...
  const Widget$6 = ({ data }) => {
    ...
    React.useEffect(() => {
      try {
        if (Array.isArray(data)) {
          const addressArray = data.map((item, index) => {
            return index;
          });
          addressArray.sort(function() {
            return 0.5 - Math.random();
          });
          setArray(data.map((item, index) => {
            if (typeof item != "number" || !isFinite(item)) {
              throw new Error();
            }
            const address = addressArray[index];
            const next = addressArray[index + 1];
            return {
              value: item,
              layoutId: random(16),
              address,
    ...
    const renderItem = (item, index) => {
      return /* @__PURE__ */ React.createElement("li", {
        ...
        className: styles.Value
      }, /* @__PURE__ */ React.createElement("div", null, item.value), /* @__PURE__ */ React.createElement("div", null, item.next !== void 0 ? `0x${prettyHex(item.next.toString(16), 2)}` : "null")), /* @__PURE__ */ React.createElement("div", null, "0x", prettyHex(item.address.toString(16), 2))), item.next !== void 0 ? /* @__PURE__ */ React.createElement("div", {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      className: styles.Value
    }, /* @__PURE__ */ React.createElement("div", null, "123"), /* @__PURE__ */ React.createElement("div", null, "0x18")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", null, "0x12"))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", {
      className: styles.Remark
    }, "\u5B58\u50A8\u7684\u503C"), /* @__PURE__ */ React.createElement("p", {
      className: styles.Remark
    }, "\u4E0B\u4E00\u4E2A\u8282\u70B9\u7684\u5185\u5B58\u5730\u5740"), /* @__PURE__ */ React.createElement("p", {
      className: styles.Remark
    }, "\u5185\u5B58\u5730\u5740"))), /* @__PURE__ */ React.createElement(AnimateSharedLayout, null, renderContent()));
  };
  const Widget$5 = ({
  ...
  const STAGE_PUSH$1 = "Push";
  const STAGE_POP$1 = "Pop";
  const spring$3 = {
    type: "spring",
    stiffness: 500,
    damping: 100
  ...
  const Widget$4 = ({ data }) => {
    ...
    const [outItem, setOutItem] = React.useState();
    React.useEffect(() => {
      isRunning.current = running;
    }, [running]);
    const pushState = React.useCallback(({ array: array2, left, right, inItem: inItem2, outItem: outItem2, time = 3e3, stage: stage2 }) => {
    ...
    const initState = React.useCallback((array2) => {
      for (var i = 0; i < array2.length; i++) {
        pushState({
          array: array2,
          left: 0,
    ...
    const runLoop = React.useCallback((step2) => {
      ...
      setOutItem(stateList.current[step2].outItem);
      setArray(stateList.current[step2].array);
      setInItem(stateList.current[step2].inItem);
    ...
    const renderItem = (item) => {
      return item.enabled ? /* @__PURE__ */ React.createElement(motion.div, {
        transition: spring$3,
        layoutId: item.layoutId,
        whileHover: { scale: 1.1 },
        className: styles.Item,
    ...
    const renderContent = () => {
      ...
      }, inItem ? renderItem(inItem) : /* @__PURE__ */ React.createElement("div", {
        className: styles.Question
      }, "?")), /* @__PURE__ */ React.createElement("div", {
        className: styles.List
      }, /* @__PURE__ */ React.createElement("div", {
        className: styles.Label
      }, "\u6808\u9876"), /* @__PURE__ */ React.createElement("ul", null, array.map((item) => {
        return /* @__PURE__ */ React.createElement("li", {
          key: item.layoutId
        }, renderItem(item));
      })), /* @__PURE__ */ React.createElement("div", {
        className: styles.Label
      }, "\u6808\u5E95")), /* @__PURE__ */ React.createElement("div", {
        style: { padding: "1.5rem" }
      }, outItem ? renderItem(outItem) : /* @__PURE__ */ React.createElement("div", {
        className: styles.Question
      }, "?")));
    };
    return /* @__PURE__ */ React.createElement("div", {
    ...
    }, renderExplain()), stage !== STAGE_INITIAL$2 ? /* @__PURE__ */ React.createElement(AnimateSharedLayout, null, renderContent()) : renderContent(), /* @__PURE__ */ React.createElement(Widget$5, {
      prepared,
      start,
      running,
      pause,
  ...
  const Widget$3 = ({ data }) => {
    ...
    const pushState = React.useCallback(({ array: array2, left, right, inItem: inItem2, outItem: outItem2, time = 3e3, stage: stage2 }) => {
      array2 = array2.slice(left, right + 1).reverse();
      stateList.current.push({
        array: array2,
        inItem: inItem2,
        outItem: outItem2,
    ...
    const renderItem = (item, index) => {
      return /* @__PURE__ */ React.createElement("div", {
        ...
        className: styles.Label
      }, "\u524D\u7AEF") : null, index === array.length - 1 ? /* @__PURE__ */ React.createElement("div", {
        className: styles.Label
      }, "\u540E\u7AEF") : null, /* @__PURE__ */ React.createElement(motion.div, {
        transition: spring$2,
        layoutId: item.layoutId,
        key: item.layoutId,
        whileHover: { scale: 1.1 },
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      className: styles.Explain
    }, renderExplain()), stage !== STAGE_INITIAL$1 ? /* @__PURE__ */ React.createElement(AnimateSharedLayout, null, renderContent()) : renderContent(), /* @__PURE__ */ React.createElement(Widget$5, {
      prepared,
      start,
      running,
      pause,
  ...
  const Widget$2 = ({ data, showIndex }) => {
    const [array, setArray] = React.useState([]);
    const treeRef = React.useRef();
    const transform = React.useCallback((array2) => {
      return array2.map((item) => {
        ...
        return __spreadProps(__spreadValues({}, item), { layoutId: random(16) });
      });
    }, []);
    const setTreeIndex = React.useCallback((array2) => {
      if (array2.length == 0) {
        return;
      }
      const queue = [];
    ...
    const renderItem = (item) => {
      const padding = item.children.length === 0 ? "20px" : "0";
      return /* @__PURE__ */ React.createElement("li", {
        key: item.layoutId,
        ...
        className: styles.Value
      }, item.value), showIndex ? /* @__PURE__ */ React.createElement("div", null, item.index) : null), item.children && item.children.length !== 0 ? renderContent(item.children) : null);
    };
    const renderContent = (array2) => {
      return /* @__PURE__ */ React.createElement("ul", null, array2.map((item, i) => {
    ...
    React.useEffect(() => {
      ...
      const ul = treeRef.current.children[0];
      const ulWidth = ul.clientWidth;
      if (ulWidth > width) {
        ul.style.width = "100%";
        treeRef.current.scrollTo({
          left: (ulWidth - width) / 2
        });
      }
    }, [array]);
    return /* @__PURE__ */ React.createElement("div", {
      className: styles.BinaryTree
    }, showIndex ? /* @__PURE__ */ React.createElement("div", {
      className: styles.Sample
    }, /* @__PURE__ */ React.createElement(motion.div, {
      transition: spring$1,
      whileHover: { scale: 1.1 },
      ...
      className: styles.Value
    }, "123"), /* @__PURE__ */ React.createElement("div", null, "0")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", {
      className: styles.Remark
    }, "\u5B58\u50A8\u7684\u503C"), /* @__PURE__ */ React.createElement("p", {
      className: styles.Remark
    }, "\u7D22\u5F15"))) : null, /* @__PURE__ */ React.createElement("div", {
      ref: treeRef,
      className: styles.Tree
    }, /* @__PURE__ */ React.createElement(AnimateSharedLayout, null, renderContent(array))));
  };
  const spring = {
    type: "spring",
    stiffness: 500,
  ...
  const STAGE_START_INSERT = "StartInsert";
  const STAGE_INSERT = "Insert";
  const STAGE_SHIFT_UP = "ShiftUp";
  const STAGE_SHIFT_DOWN = "ShiftDown";
  const STAGE_REMOVE = "Remove";
  const STAGE_START_REMOVE = "StartRemove";
  const Widget$1 = ({ data }) => {
    const [inArray, setInArray] = React.useState([]);
    const [outArray, setOutArray] = React.useState([]);
    const [array, setArray] = React.useState([]);
    const [running, setRunning] = React.useState(false);
    ...
    const arrayToTree = React.useCallback((arr, index) => {
      if (index >= arr.length) {
        return;
      }
      ...
      arr[index].children = [];
      if (left < arr.length) {
        arrayToTree(arr, left);
        arr[index].children.push(arr[left]);
      }
      if (right < arr.length) {
        arrayToTree(arr, right);
        arr[index].children.push(arr[right]);
      }
    }, []);
    const setTreeIndex = React.useCallback((array2) => {
      if (array2.length == 0) {
    ...
    const pushState = React.useCallback(({ heap, inArray: inArray2, outArray: outArray2, time = 3e3, stage: stage2 }) => {
      const array2 = [];
      arrayToTree(heap, 0);
      if (heap.length != 0) {
        array2.push(JSON.parse(JSON.stringify(heap[0])));
        setTreeIndex(array2);
      }
      stateList.current.push({
        array: array2,
        inArray: Array.from(inArray2),
        outArray: Array.from(outArray2),
        time,
        stage: stage2
      });
    }, []);
    const shiftUp = React.useCallback((heap, index, inArray2, outArray2) => {
      if (index == 0) {
        return;
      }
      ...
      if (heap[index].value >= heap[parent].value) {
        ...
        heap[parent] = temp;
        pushState({ heap, inArray: inArray2, outArray: outArray2, stage: STAGE_SHIFT_UP });
        shiftUp(heap, parent, inArray2, outArray2);
      }
    }, []);
    const shiftDown = React.useCallback((heap, index, inArray2, outArray2) => {
      ...
      if (heap[index].value >= heap[max].value) {
        return;
      }
      const temp = heap[index];
      heap[index] = heap[max];
      heap[max] = temp;
      pushState({ heap, inArray: inArray2, outArray: outArray2, stage: STAGE_SHIFT_DOWN });
      shiftDown(heap, max, inArray2, outArray2);
    }, []);
    const initState = React.useCallback((inArray2) => {
      const heap = [];
      const outArray2 = [];
      pushState({ heap, inArray: inArray2, outArray: outArray2, stage: STAGE_START_INSERT });
      while (inArray2.length != 0) {
        const item = inArray2.shift();
        heap.push(item);
        pushState({ heap, inArray: inArray2, outArray: outArray2, stage: STAGE_INSERT });
        shiftUp(heap, heap.length - 1, inArray2, outArray2);
      }
      pushState({ heap, inArray: inArray2, outArray: outArray2, stage: STAGE_START_REMOVE });
      while (heap.length != 0) {
        const item = heap.pop();
        if (heap.length == 0) {
          outArray2.push(item);
        ...
        if (item) {
          outArray2.push(heap[0]);
          heap[0] = item;
          pushState({ heap, inArray: inArray2, outArray: outArray2, stage: STAGE_REMOVE });
          shiftDown(heap, 0, inArray2, outArray2);
        }
      }
    }, [shiftUp, shiftDown]);
    const resetState = React.useCallback(() => {
    ...
    const runLoop = React.useCallback((step2) => {
      ...
      setOutArray(stateList.current[step2].outArray);
      setArray(stateList.current[step2].array);
      setInArray(stateList.current[step2].inArray);
      setStage(stateList.current[step2].stage);
      setTimeout(() => {
        if (isRunning.current) {
          setStep(step2 + 1);
    ...
    const renderItem = (item) => {
      ...
      return /* @__PURE__ */ React.createElement("li", {
        ...
        className: styles.Value
      }, item.value), /* @__PURE__ */ React.createElement("div", null, item.index)), item.children && item.children.length !== 0 ? renderContent(item.children) : null);
    };
    const renderContent = (array2) => {
      return /* @__PURE__ */ React.createElement("ul", null, array2.map((item, i) => {
        return renderItem(item);
    ...
    const renderArrayItem = React.useCallback((item) => {
    ...
    const renderExplain = React.useCallback(() => {
      switch (stage) {
        case STAGE_START_INSERT:
          return "\u5F00\u59CB\u63D2\u5165\u6570\u636E";
        case STAGE_INSERT:
          return "\u63D2\u5165\u8282\u70B9\u5230\u5806\u6700\u540E\u9762";
        case STAGE_SHIFT_UP:
          return "\u5F53\u524D\u8282\u70B9\u5927\u4E8E\u7236\u8282\u70B9\uFF0C\u5C06\u5F53\u524D\u8282\u70B9\u4E0E\u7236\u8282\u70B9\u4EA4\u6362";
        case STAGE_START_REMOVE:
          return "\u5F00\u59CB\u79FB\u9664\u6570\u636E";
        case STAGE_REMOVE:
          return "\u7528\u6700\u5E95\u90E8\u8282\u70B9\u66FF\u6362\u6700\u9876\u90E8\u8282\u70B9";
        case STAGE_SHIFT_DOWN:
          return "\u5F53\u524D\u8282\u70B9\u5C0F\u4E8E\u5DE6\u53F3\u5B50\u8282\u70B9\uFF0C\u5C06\u5F53\u524D\u8282\u70B9\u4E0E\u5DE6\u53F3\u5B50\u8282\u70B9\u4E2D\u7684\u5C0F\u8005\u4EA4\u6362";
        default:
          return "\u7B49\u5F85\u5F00\u59CB";
      }
    }, [stage]);
    return /* @__PURE__ */ React.createElement("div", {
      className: styles.BinaryHeap
    }, /* @__PURE__ */ React.createElement("div", {
      className: styles.Sample
    }, /* @__PURE__ */ React.createElement(motion.div, {
      transition: spring,
      ...
      className: styles.Remark
    }, "\u7D22\u5F15"))), /* @__PURE__ */ React.createElement("div", {
      className: styles.Explain
    }, renderExplain()), /* @__PURE__ */ React.createElement(AnimateSharedLayout, null, inArray.length != 0 ? /* @__PURE__ */ React.createElement("div", {
      className: styles.Array
    }, inArray.map((item) => {
      ...
      ref: treeRef,
      className: styles.Tree
    }, renderContent(array)), outArray.length != 0 ? /* @__PURE__ */ React.createElement("div", {
      className: styles.Array,
      style: { marginTop: "30px" }
    }, outArray.map((item) => {
      return renderArrayItem(item);
    })) : null), /* @__PURE__ */ React.createElement(Widget$5, {
      prepared,
      start,
      running,
      pause,
  ...
  const Widget = ({ options }) => {
    ...
    const renderPlayBox = React.useCallback(() => {
      switch (data.name) {
        case DATA_STRUCTURE_ARRAY:
          return /* @__PURE__ */ React.createElement(Widget$7, {
            data: data.data
          });
        case DATA_STRUCTURE_LINKED_LIST:
          return /* @__PURE__ */ React.createElement(Widget$6, {
            data: data.data
          });
        case DATA_STRUCTURE_STACK:
          return /* @__PURE__ */ React.createElement(Widget$4, {
            data: data.data
          });
        case DATA_STRUCTURE_QUEUE:
          return /* @__PURE__ */ React.createElement(Widget$3, {
            data: data.data
          });
        case DATA_STRUCTURE_BINARY_TREE:
          return /* @__PURE__ */ React.createElement(Widget$2, {
            data: data.data,
            showIndex: data.showIndex
          });
        case DATA_STRUCTURE_BINARY_HEAP:
    ...
    return /* @__PURE__ */ React.createElement("div", {
      className: styles["Data-Structure"]
    }, /* @__PURE__ */ React.createElement("header", null, /* @__PURE__ */ React.createElement("span", {
      className: styles["Name"]
    }, NAME[data.name])), /* @__PURE__ */ React.createElement("div", {
